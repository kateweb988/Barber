...
$(document).ready(function () {
  ...
  // Открытие popup-call
  $(document).on('click', 'a.js-popup-call, .footer__link', function (e) {
    e.preventDefault();
    $('#popup-call').arcticmodal();
  });

  // Закрытие ТЕКУЩЕГО попапа
  $(document).on('click', '.articmodal-close', function (e) {
    e.preventDefault();
    $(this).closest('.box-modal').arcticmodal('close');
  });

  // Жёсткое закрытие ВСЕХ попапов (thank)
  ...
  $('.js-form').each(function () {
    ...
    $(this).validate({
      ...
      submitHandler: function (form) {
        ...
        var $form = $(form);
        var $modal = $form.closest('.box-modal');
